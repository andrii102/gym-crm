-- Insert into users
INSERT INTO users (id, first_name, last_name, username, password, role, is_active)
VALUES (1, 'John', 'Doe', 'john.doe', '$2a$12$K6ba191yQ/dIxUkk2jkxuOkE/p8GXcwHQmngLM1hahT6ag8dvf.Ae', 'TRAINER', TRUE) ON CONFLICT (id) DO NOTHING;    -- pass123
INSERT INTO users (id, first_name, last_name, username, password, role, is_active)
VALUES (2, 'Jane', 'Smith', 'jane.smith', '$2a$12$VwAJCap5EXK1GWYTc82Ctuhv2SUqtNRxd.wRt4jDnaU36VifNIkTy','TRAINER', TRUE) ON CONFLICT (id) DO NOTHING;    -- pass456
INSERT INTO users (id, first_name, last_name, username, password, role, is_active)
VALUES (3, 'Mike', 'Brown', 'mike.brown', '$2a$12$h8Qi3AxlSl3fZ.CmRvpvfux.Qv21doYN8HvXvD3a4mTHFgNVg59t.','TRAINER', TRUE) ON CONFLICT (id) DO NOTHING;    --pass789
INSERT INTO users (id, first_name, last_name, username, password, role, is_active)
VALUES (4, 'Emma', 'White', 'emma.white', '$2a$12$SFPGKmJ/YXobesc4hDjb/.cHt9cWNg8/InRMScuDWzxEVxyfAkybO','TRAINER', TRUE) ON CONFLICT (id) DO NOTHING;    --pass321
INSERT INTO users (id, first_name, last_name, username, password, role, is_active)
VALUES (5, 'Jessica', 'Black', 'jessica.black', '$2a$12$7N.9t0j3XgH/wWbpqWmBPeLvHne7vAr.jrcO9a5hLLvOgBXuYml0u','TRAINEE', TRUE) ON CONFLICT (id) DO NOTHING;  --pass654
INSERT INTO users (id, first_name, last_name, username, password, role, is_active)
